...
CREATE TABLE `medicine_master` (
    ...
    `product_name`          VARCHAR(1000) NOT NULL COMMENT '한글상품명',
    `company_name`          VARCHAR(500) COMMENT '업체명',
    `spec`                  VARCHAR(500) COMMENT '약품규격',
    ...
    `serial_omit_reason`    VARCHAR(255) COMMENT '일련번호생략사유',
